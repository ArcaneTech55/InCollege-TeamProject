...
4100-VALIDATE-PASSWORD.
       ...
       PERFORM VARYING IDX FROM 1 BY 1 UNTIL IDX > WS-PASSWORD-LENGTH
        IF WS-INPUT-PASSWORD(IDX:1) >= 'A' AND <= 'Z'
            MOVE 'Y' TO WS-HAS-CAPITAL
        END-IF
        IF WS-INPUT-PASSWORD(IDX:1) >= '0' AND <= '9'
            MOVE 'Y' TO WS-HAS-DIGIT
        END-IF
        INSPECT WS-SPECIAL-CHARS TALLYING I
           FOR CHARACTERS BEFORE INITIAL WS-INPUT-PASSWORD(I:1)
        IF I < FUNCTION LENGTH(WS-SPECIAL-CHARS)
